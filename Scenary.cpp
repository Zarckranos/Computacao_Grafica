...
void Scenary::adicionarObjeto(Shape* shape)
{
    this->shapes.push_back(shape);
};

void Scenary::adicionarLuz(Lighting* light)
{
    this->lights.push_back(light);
};

void Scenary::addCamera(Camera camera)
{
    this->camera = camera;
};

void Scenary::addLuzAmbiente(AmbientLighting ambientLight)
{
