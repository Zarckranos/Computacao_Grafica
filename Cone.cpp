...
void Cone::applyTransform(Matriz transform)
{
    ...
    axisv = transform * axisv.normalized();
    this->axis = VertexToPoint(axisv);
...
void Cone::setCameraCoordinates(Matriz worldToCamera)
{
    ...
    Vertex axisv = Vertex(this->axis[0], this->axis[1], this->axis[2], 0);
    axisv = worldToCamera * axisv;
    this->axis = VertexToPoint(axisv).normalized();
